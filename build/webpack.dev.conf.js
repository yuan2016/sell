...
var FriendlyErrorsPlugin = require('friendly-errors-webpack-plugin')//美化error输出
...
module.exports = merge(baseWebpackConfig, {
  ...
  // 使用 #eval-source-map 模式作为开发工具，此配置可参考 DDFE 往期文章详细了解 方便源码调试
